...
const StartJam3a: React.FC = () => {
  ...
  const content = {
    ...
    ar: {
      ...
      description: "إنشاء جمعة سريع وسهل. اختر منتج تحبه، حدد حجم مجموعتك، وشاهد الأسعار تنخفض مع انضمام المزيد من الأصدقاء!",
      ...
      steps: [
        ...
        },
        {
          ...
          description: "قرر كم عدد الأشخاص اللي تبيهم في مجموعتك. كلما كبرت المجموعة، كلما زاد التوفير!",
          icon: Users
        },
        {
          title: "ادع أصدقاءك",
